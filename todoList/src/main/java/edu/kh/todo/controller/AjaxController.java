 ...
 * 
 * -> 컨트롤러 메서드의 반환값을
 * 비동기 요청했던 HTML/JS 파일 부분에 값을 그대로 돌려보낼 것이다를 명시
 * 
 * -> 해당 어노테이션이 붙은 컨트롤러의 메서드는 return에 작성된 값이 forward/redirect로 인식
 * 되는 게 아님
 * 
 * @RequestBody
...
@Controller // 요청과 응답을 제어하는 역할 명시 + Bean 등록
