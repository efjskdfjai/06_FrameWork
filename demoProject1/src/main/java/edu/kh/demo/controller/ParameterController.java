...
public class ParameterController {
	 ...
	 * -> "" (빈문자열)일 때는 에러 발생 x (파라미터가 존재하지 않는 것이 아니라
	 * name 속성값=""으로 넘어오기 때문에)
	 * 
	...
	public String paramTest2(@RequestParam("title") String title,
			...
			@RequestParam("price") int price, // 형변환이 필요한 경우에는 파라미터 value 값 필수 작성되어있어야 함
	...
	public String paramTest4(/*@ModelAttribute*/ MemberDTO inputMember) {
		...
		return "redirect:main"; // 상대경로 작성법 (현재위치가 중요! 
		// =="redirect:/param/main"
		//-> 현재 경로의 가장 마지막 부분을 redirect:이 주소로 변경하기 때문에)
